...
export default function Home() {
  ...
  return (
    <div className="flex flex-col bg-slate-50 dark:bg-[#020617] transition-colors overflow-x-hidden">
      ...
      <section className="min-h-[90vh] sm:min-h-[95vh] flex flex-col justify-center px-4 sm:px-6 overflow-hidden relative border-b border-slate-200 dark:border-white/5">
        ...
        <div className="max-w-7xl mx-auto relative z-10 flex flex-col items-center text-center">
          ...
          <motion.p 
            ...
            className="text-lg md:text-2xl text-slate-600 dark:text-slate-300 font-medium max-w-3xl leading-relaxed mb-20 px-4"
          >
          ...
          >
            <Link to="/explore" className="w-full group relative overflow-hidden bg-slate-950 dark:bg-white text-white dark:text-slate-950 px-8 py-5 rounded-[1.5rem] text-xs font-black uppercase tracking-[3px] transition-all hover:scale-[1.02] active:scale-95 shadow-2xl">
            ...
            <Link to="/post-task" className="w-full px-8 py-5 rounded-[1.5rem] border-2 border-slate-200 dark:border-white/10 text-slate-900 dark:text-white text-xs font-black uppercase tracking-[3px] hover:bg-slate-50 dark:hover:bg-white/5 transition-all">
              Publicar Tarea
            </Link>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-16 relative z-10">
           {[
             ...
             <motion.div 
               ...
               className="group p-7 sm:p-10 rounded-[1.5rem] bg-white/40 dark:bg-slate-900/40 backdrop-blur-xl border border-slate-200/50 dark:border-white/5 hover:border-indigo-500/30 dark:hover:border-indigo-500/30 transition-all duration-500 hover:shadow-xl hover:shadow-indigo-500/10"
             >
               <div className={cn(
                  "w-14 h-14 sm:w-16 sm:h-16 rounded-2xl flex items-center justify-center mb-6 shadow-md group-hover:scale-110 transition-transform duration-500",
               ...
               <p className="text-slate-500 dark:text-slate-300 font-medium leading-relaxed">{feature.desc}</p>
             </motion.div>
           ))}
        </div>
      </section>
      ...
      <section className="py-16 sm:py-28 px-4 sm:px-6 bg-slate-50/50 dark:bg-white/[0.02] border-y border-slate-200 dark:border-white/5">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12 px-0 sm:px-4">
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
              {tasks.length === 0 ? (
                <div className="col-span-2 text-center py-20 bg-white dark:bg-slate-900/40 rounded-[1.5rem] border-2 border-dashed border-slate-200 dark:border-white/10">
      ...
      <section className="py-16 sm:py-28 px-4 sm:px-6">
        <motion.div 
          ...
          viewport={{ once: true }}
          className="max-w-7xl mx-auto bg-slate-950 dark:bg-indigo-600 rounded-[2rem] p-10 sm:p-20 text-center relative overflow-hidden shadow-[0_40px_80px_-20px_rgba(0,0,0,0.4)] border border-white/5"
        >
           ...
           <h2 className="text-4xl sm:text-6xl font-black text-white tracking-tighter leading-[0.85] mb-8 relative z-10 max-w-4xl mx-auto">
             ¿LISTO PARA <br/>LO SIGUIENTE?
           </h2>
           
           <p className="text-indigo-200/60 dark:text-white/70 text-lg md:text-2xl font-medium mb-12 sm:mb-20 relative z-10 max-w-2xl mx-auto leading-relaxed">
